...
--> statement-breakpoint
INSERT INTO `__new_workouts`("id", "user_id", "cycle_id", "date", "primary_lift", "status", "sequence", "created_at", "updated_at", "completed_at") SELECT "id", "user_id", "cycle_id", "date", "primary_lift", "status", "sequence", "created_at", "updated_at", "completed_at" FROM `workouts`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `one_rep_maxes_user_id_exercise_definition_id_unique` ON `one_rep_maxes` (`user_id`,`exercise_definition_id`);